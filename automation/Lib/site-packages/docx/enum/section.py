...
class WD_HEADER_FOOTER_INDEX(BaseXmlEnum):
    ...
    URL: https://docs.microsoft.com/pt-BR/office/vba/api/word.wdheaderfooterindex
    """
...
class WD_ORIENTATION(BaseXmlEnum):
    ...
    MS API URL: http://msdn.microsoft.com/pt-BR/library/office/ff837902.aspx
    """
...
class WD_SECTION_START(BaseXmlEnum):
    ...
    MS API URL: http://msdn.microsoft.com/pt-BR/library/office/ff840975.aspx
    """
