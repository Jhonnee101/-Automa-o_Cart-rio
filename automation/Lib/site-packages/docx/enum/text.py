...
class WD_BREAK_TYPE(enum.Enum):
    ...
    http://msdn.microsoft.com/pt-BR/library/office/ff195905.aspx.
    """
...
class WD_COLOR_INDEX(BaseXmlEnum):
    ...
    * URL: https://msdn.microsoft.com/pt-BR/library/office/ff195343.aspx
    """
...
class WD_LINE_SPACING(BaseXmlEnum):
    ...
    URL: http://msdn.microsoft.com/pt-BR/library/office/ff844910.aspx
    """
...
class WD_TAB_ALIGNMENT(BaseXmlEnum):
    ...
    URL: https://msdn.microsoft.com/PT-BR/library/office/ff195609.aspx
    """
...
class WD_TAB_LEADER(BaseXmlEnum):
    ...
    URL: https://msdn.microsoft.com/pt-BR/library/office/ff845050.aspx
    """
...
class WD_UNDERLINE(BaseXmlEnum):
    ...
    URL: http://msdn.microsoft.com/pt-BR/library/office/ff822388.aspx
    """
