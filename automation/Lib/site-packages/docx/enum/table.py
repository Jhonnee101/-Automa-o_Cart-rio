...
class WD_CELL_VERTICAL_ALIGNMENT(BaseXmlEnum):
    ...
    https://msdn.microsoft.com/pt-BR/library/office/ff193345.aspx
    """
...
class WD_ROW_HEIGHT_RULE(BaseXmlEnum):
    ...
    https://msdn.microsoft.com/pt-BR/library/office/ff193620.aspx
    """
...
class WD_TABLE_ALIGNMENT(BaseXmlEnum):
    ...
    http://office.microsoft.com/pt-BR/word-help/HV080607259.aspx
    """
...
class WD_TABLE_DIRECTION(BaseEnum):
    ...
    http://msdn.microsoft.com/pt-BR/library/ff835141.aspx
    """
